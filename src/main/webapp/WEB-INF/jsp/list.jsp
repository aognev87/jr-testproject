...
<center>
  ...
  <div style="color: teal; font-size: 30px">Java Rush CRUD | User Details</div><br>
  ...
  <c:if test="${!empty userList}">
   <table border="1" bgcolor="black" width="600px">
    ...
    <c:forEach items="${userList}" var="user" varStatus="loopCounter">
     <tr
      ...
      height="30px">
        ...
        <form:form id="gotoPageForm_0" method="post" modelAttribute="page" action="listAction">
    ...
    <form:form id="gotoPageForm_1" method="post" modelAttribute="page" action="listAction">
    ...
    <form:form id="gotoPageForm_2" method="post" modelAttribute="page" action="listAction">
         <form:input type="hidden" path="userId" value="${page.userId}" />
         <form:input type="hidden" path="name" value="${page.name}" />
         <form:input type="hidden" path="age" value="${page.age}" />
         <form:input type="hidden" path="isAdmin" value="${page.isAdmin}" />
